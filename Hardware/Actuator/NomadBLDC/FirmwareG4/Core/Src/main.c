...
static void MX_ADC4_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(FET_TEMP_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC4, LL_ADC_CHANNEL_4, LL_ADC_SAMPLINGTIME_47CYCLES_5);
...
static void MX_ADC5_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(EXT_TEMP_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC5, LL_ADC_CHANNEL_2, LL_ADC_SAMPLINGTIME_47CYCLES_5);
...
static void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.NominalTimeSeg1 = 135; // Between 2 and 256
  hfdcan3.Init.NominalTimeSeg2 = 34; // Between 2 and 128
  hfdcan3.Init.NominalSyncJumpWidth = 34; // Between 1 and 128
  hfdcan3.Init.DataPrescaler = 17; // Between 1 and 32
  hfdcan3.Init.DataTimeSeg1 = 2; // Between 1 and 32
  hfdcan3.Init.DataTimeSeg2 = 2; // Between 1 and 16
  hfdcan3.Init.DataSyncJumpWidth = 2; // Between 1 and 16
...
static void MX_SPI1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(ENC_SCK_GPIO_Port, &GPIO_InitStruct);
...
static void MX_SPI2_Init(void)
{
  ...
  PA10   ------> SPI2_MISO
  */
  GPIO_InitStruct.Pin = DRV_SCK_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_5;
  LL_GPIO_Init(DRV_SCK_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = DRV_MOSI_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_5;
  LL_GPIO_Init(DRV_MOSI_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = DRV_MISO_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_5;
  LL_GPIO_Init(DRV_MISO_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM2_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetFilter(TIM2, LL_TIM_CHANNEL_CH2, LL_TIM_IC_FILTER_FDIV2_N6);
...
static void MX_TIM8_Init(void)
{
  ...
  TIM_OC_InitStruct.CompareValue = 1050;
  ...
  */
  ...
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_10;
  LL_GPIO_Init(PWM_C_GPIO_Port, &GPIO_InitStruct);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(ENC_CS_GPIO_Port, ENC_CS_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ENC_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(DRV_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(USER_GPIO_GPIO_Port, &GPIO_InitStruct);
