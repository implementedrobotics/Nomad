...
static void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.NominalTimeSeg1 = 79; // Between 2 and 256
  hfdcan3.Init.NominalTimeSeg2 = 20; // Between 2 and 128
  hfdcan3.Init.NominalSyncJumpWidth = 20; // Between 1 and 128
