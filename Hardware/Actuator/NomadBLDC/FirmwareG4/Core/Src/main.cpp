...
/* USER CODE BEGIN PFP */
static void rtos_startup(void *argument);
...
{
    {
        ...
        defaultTaskHandle = osThreadNew(rtos_startup, NULL, &defaultTask_attributes);
...
void rtos_startup(void *argument)
{
    /* USER CODE BEGIN 5 */
    osThreadNew(init_uart_threads, (void *)USART2, NULL); // Start UART Thread
    /* USER CODE END 5 */
}
