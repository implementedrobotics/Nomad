...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<Communications::Port> SIM_IMU = Communications::Port::CreateOutput("SIM_IMU", 10);
    SIM_IMU->SetTransport(Communications::Port::TransportType::UDP, sim_url, "nomad.sim.imu_state");

    std::shared_ptr<Communications::Port> JOINT_STATE = Communications::Port::CreateOutput("SIM_JOINT_STATE", 10);
    JOINT_STATE->SetTransport(Communications::Port::TransportType::UDP, sim_url, "nomad.sim.joint_state");

    std::shared_ptr<Communications::Port> COM_STATE = Communications::Port::CreateOutput("SIM_COM_STATE", 10);
    COM_STATE->SetTransport(Communications::Port::TransportType::UDP, sim_url, "nomad.sim.com_state");
    ...
    nomad_simulation_interface.SetPortOutput(Robot::Nomad::Interface::SimulationInterface::IMU_STATE_OUT,
                                             Communications::Port::TransportType::INPROC, "inproc", "nomad.imu");

    nomad_simulation_interface.SetPortOutput(Robot::Nomad::Interface::SimulationInterface::JOINT_STATE_OUT,
                                             Communications::Port::TransportType::INPROC, "inproc", "nomad.joint_state");

    nomad_simulation_interface.SetPortOutput(Robot::Nomad::Interface::SimulationInterface::COM_STATE_OUT,
                                             Communications::Port::TransportType::INPROC, "inproc", "nomad.com_state");

    Communications::Port::Map(nomad_simulation_interface.GetInputPort(Robot::Nomad::Interface::SimulationInterface::InputPort::IMU_STATE_IN),
                        SIM_IMU);

    Communications::Port::Map(nomad_simulation_interface.GetInputPort(Robot::Nomad::Interface::SimulationInterface::InputPort::JOINT_STATE_IN),
                        JOINT_STATE);

    Communications::Port::Map(nomad_simulation_interface.GetInputPort(Robot::Nomad::Interface::SimulationInterface::InputPort::COM_STATE_IN),
                        COM_STATE);
    ...
    Communications::Port::Map(nomad_dynamics_node.GetInputPort(Robot::Nomad::Dynamics::NomadDynamics::InputPort::JOINT_STATE),
    ...
    estimator_node.SetPortOutput(Robot::Nomad::Estimators::FusedLegKinematicsStateEstimator::OutputPort::BODY_STATE_HAT,
                                 Communications::Port::TransportType::INPROC, "inproc", "nomad.com.state");

    //Communications::Port::Map(nomad_dynamics_node.GetInputPort(Robot::Nomad::Dynamics::NomadDynamics::BODY_STATE_HAT),
      //                  estimator_node.GetOutputPort(Robot::Nomad::Estimators::FusedLegKinematicsStateEstimator::BODY_STATE_HAT));

    Communications::Port::Map(estimator_node.GetInputPort(Robot::Nomad::Estimators::FusedLegKinematicsStateEstimator::InputPort::IMU_DATA),
                         nomad_simulation_interface.GetOutputPort(Robot::Nomad::Interface::SimulationInterface::OutputPort::IMU_STATE_OUT));

    Communications::Port::Map(estimator_node.GetInputPort(Robot::Nomad::Estimators::FusedLegKinematicsStateEstimator::InputPort::JOINT_STATE),
                         nomad_simulation_interface.GetOutputPort(Robot::Nomad::Interface::SimulationInterface::OutputPort::JOINT_STATE_OUT));

    Communications::Port::Map(estimator_node.GetInputPort(Robot::Nomad::Estimators::FusedLegKinematicsStateEstimator::InputPort::COM_STATE),
    ...
    // Communications::Port::Map(nomad_controller_node.GetInputPort(Robot::Nomad::Controllers::NomadControl::InputPort::CONTROL_MODE),
    //                     teleop_node.GetOutputPort(OperatorInterface::Teleop::RemoteTeleop::OutputPort::MODE));

    // //nomad_controller_node.Start();

    // Port Mappings
    Communications::Port::Map(nomad_dynamics_node.GetInputPort(Robot::Nomad::Dynamics::NomadDynamics::InputPort::BODY_STATE_HAT),
