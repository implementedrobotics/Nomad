...
#ifndef __joint_state_t_hpp__
#define __joint_state_t_hpp__
...
int joint_state_t::encode(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int joint_state_t::decode(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t joint_state_t::getEncodedSize() const
{
...
int joint_state_t::_encodeNoHash(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int joint_state_t::_decodeNoHash(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t joint_state_t::_getEncodedSizeNoHash() const
{
    uint32_t enc_size = 0;
...
uint64_t joint_state_t::_computeHash(const __zcm_hash_ptr*)
{
    uint64_t hash = (uint64_t)0x364598414f4fbd1bLL;
